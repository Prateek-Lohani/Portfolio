...
const Skills = () => {
    ...
    <div className='w-full h-fit p-4 relative'>
        ...
        <h5 className='text-6xl md:text-8xl font-extrabold p-2 font-[circular]'>Skills</h5>
        <p className='pb-8 md:pb-12 md:w-[50%] w-[75%] text-xl md:text-2xl py-6 leading-[30px] tracking-tight font-normal'>
