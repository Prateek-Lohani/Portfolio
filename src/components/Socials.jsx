...
const data=[
 ...
 const [socials,setSocials]=useState(data);
    ...
    return (
    <div ref={refer} className='w-full bg-cyan-600/70 md:pt-[10vh] p-4 h-[30vh] md:h-fit  flex flex-col items-center justify-center relative'>
        
        <div className="form-container w-[60%] h-[70vh] bg-yellow-500">
            <Form/>
        </div>
