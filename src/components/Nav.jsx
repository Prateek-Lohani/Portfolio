...
const Nav = ({scrollToSkills,scrollToProjects,scrollToExperience,scrollToResume,scrollToSocials}) => {
    ...
    return (
    <nav className='fixed h-[6vh] md:h-[8vh] text-white  w-full bg-black/50 z-[9998]'>
...
<div className="left flex items-center">
    <h2 className='text-xl md:text-3xl'>𐌐𐌋</h2>
</div>
...
<div className='mob-right md:hidden flex gap-3'>
